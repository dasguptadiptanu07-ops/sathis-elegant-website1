...
export const AnimatedMarqueeHero: React.FC<AnimatedMarqueeHeroProps> = ({
  ...
  return (
    <section
      className={cn(
        "relative w-full min-h-screen overflow-hidden bg-background text-foreground flex flex-col items-center justify-between py-12 px-4 text-center",
        className
      )}
    >
      <div className="z-10 flex flex-col items-center my-auto max-w-4xl">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-6xl md:text-7xl font-bold tracking-tight text-foreground max-w-4xl"
        >
          {typeof title === 'string' ? (
